          ...
          <div className="relative flex items-center">
            <input
              ...
              className={cn(
                ...
                checked && "bg-primary-800 border-primary-800 dark:bg-primary-800 dark:border-primary-800 hover:shadow-md",
                !checked && !indeterminate && "hover:border-primary-800 dark:hover:border-primary-400 hover:shadow-md",
                indeterminate && "bg-primary-800 border-primary-800 dark:bg-primary-800 dark:border-primary-800 hover:shadow-md",
