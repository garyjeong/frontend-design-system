...
export const usePopover = (props: UsePopoverProps): UsePopoverReturn => {
  const { trigger = 'click', defaultOpen = false, open: openProp, onOpenChange } = props;
  ...
  const popoverRef = React.useRef<HTMLDivElement>(null) as React.RefObject<HTMLElement>;
