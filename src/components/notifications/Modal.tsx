  ...
  ({ className, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          "flex items-center justify-center rounded-md p-1 text-neutral-500 transition-colors hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none focus:ring-2 focus:ring-primary-500/50 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-white",
          className,
        )}
        {...props}
      >
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <footer
        ref={ref}
        className={cn(
          "flex items-center justify-end gap-2 border-t border-neutral-200 dark:border-neutral-700 px-6 py-4",
          className,
        )}
        {...props}
      >
