      ...
      {items.map((item) => {
        ...
        const content = (
          <>
            ...
            {item.badge && (
              <span className="ml-auto flex items-center justify-center h-5 px-1.5 text-[10px] font-bold rounded-full bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">
                {item.badge}
              </span>
            )}
          </>
